...
<div class="page-head">
    ...
    <div class="bread-crumb pull-left mz-breadcrumb">
        ...
        <a href="#" class="">功能测试</a>
        <span class="divider">/</span>
        <a href="#" class="bread-current">测试事务管理是否有效</a>
    </div>
        ...
        <div class="widget">
            <div class="widget-content">
                ...
                <div class="mz-toolbar">
                    <div class="btn-group">
                        <button class="btn btn-primary" target="dialog" href="${pageContext.request.contextPath}/function/test/exception/add"
                                width="850" height="350" title="新增用户"><i class="icon-plus"></i> 新增是否回滚</button>
                        <button class="btn btn-info" target="dialog" href="${pageContext.request.contextPath}/function/test/exception/update/{sid_userId}"
                                width="850" height="350" title="修改用户" warn="请选择权限" rel=""><i class="icon-edit"></i> 修改是否回滚</button>
                            <button class="btn btn-danger" target="moreRecoredDeleted" href="${pageContext.request.contextPath}/function/test/exception/deleteIds"
                                    title="确定要删除?" warn="请选择要删除的应用" rel="ids"><i class="icon-remove"></i>批量删除 是否回滚</button>
