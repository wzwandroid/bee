                        ...
                        <div class="widget-content">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>2014-09-10</td>
                                    <td>admin</td>
                                    <td>截至今日需要完成三个模块90%内容</td>
                                    <td><span class="label label-info">系统管理-》菜单管理</span></td>
                                ...
                                <tr>
                                    ...
                                    <td>admin</td>
                                    <td>截至今日需要完成三个模块90%内容</td>
                                    <td><span class="label label-info">商户门户网站->角色管理里面有树</span></td>
                                    <td><label class="red">参照 增删改以及modal中分页</label></td>
                                </tr>
                                </tbody>
                            </table>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-offset-5 col-md-7 ">
                <!-- Copyright info -->
                <p class="copy">Copyright &copy; 2014 | <a href="#">国控健康</a></p>
            </div>
        </div>
    </div>
</footer>
