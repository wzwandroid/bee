    ...
    <div class="col-md-12">
        <div class="widget wgreen">
            <div class="widget-content">
                <hr>
                <sf:form modelAttribute="merMenuInfoEntity" role="form">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div>
                            ...
                            <div class="col-md-7">
                                <sf:select path="lvl" id="lvl" cssClass="form-control" disabled="true">
                    ...
                    <div class="form-group">
                        <div>
                            ...
                            <div class="col-md-7">
                                <sf:select path="pId" id="pId" cssClass="form-control" disabled="true">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <sf:hidden path="id"/>
                            <sf:input path="name" id="name" cssClass="form-control required"  disabled="true"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-5 control-label" for="href">请求地址：</label>
                        <div class="col-md-7">
                            <sf:textarea path="href" id="href" cssClass="form-control"  disabled="true"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-5 control-label" for="iconClassName">CSS样式名：</label>
                        <div class="col-md-7">
                            <sf:input path="iconClassName" id="iconClassName" cssClass="form-control" disabled="true"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-5 control-label" for="sort">菜单顺序：</label>
                        <div class="col-md-7">
                            <sf:input path="sort" id="sort" cssClass="form-control" disabled="true"/>
                        </div>
                    </div>
                    </sf:form>
                </div>
